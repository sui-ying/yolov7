...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/cv/xyc/yolov7_plate/runs/train/exp9/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='/cv/all_training_data/plate/cn/yolov7_plate/dataset/dataset/test',
